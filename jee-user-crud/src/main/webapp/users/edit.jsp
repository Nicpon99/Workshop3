...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header table-bordered">
            <span style="font-size: 18px; color: #0077ff; font-weight: bold;">Edycja użytkownika</span>
    ...
    <form method="POST" class="table-bordered" style="padding: 20px;">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="username" value="${user.userName}" placeholder="Nazwa użytkownika">
        </div>

        <div class="form-group">
            <label>Email</label>
            <input type="email" class="form-control" name="email" value="${user.email}" placeholder="Email użytkownika">
        </div>
